...
import router from '../../router/index.js'	
	export default {
		...
		mounted(){
			axios.get("/api/getGoods?page=1&zy_ids=p8_c4_l4_1456_1186_1220_1406_1184_1217_1371_5_128_106_51_18_1391&app_name=zhe&catname=xbsytab4&flag=xbsytab4").then(res=>{
